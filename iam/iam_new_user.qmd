...
aws sts get-caller-identity --profile vr_sling
...
aws iam simulate-principal-policy \
  --policy-source-arn arn:aws:iam::711879567788:user/jdixon@mushinsolutions.com \
  --action-names s3:ListBucket \
  --resource-arns arn:aws:s3:::surgical-ed-vr-dev \
  --profile vr_sling
...
aws s3 sync s3://vr-sling s3://surgical-ed-vr-dev  --profile vr_sling
